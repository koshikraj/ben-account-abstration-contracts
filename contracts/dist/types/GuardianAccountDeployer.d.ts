...
export interface GuardianAccountDeployerInterface extends utils.Interface {
    functions: {
        "deployAccount(address,address,address,uint256)": FunctionFragment;
...
export interface GuardianAccountDeployer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GuardianAccountDeployerInterface;
    ...
    functions: {
        deployAccount(entryPoint: PromiseOrValue<string>, owner: PromiseOrValue<string>, guardian: PromiseOrValue<string>, salt: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    getAddress(entryPoint: PromiseOrValue<string>, owner: PromiseOrValue<string>, salt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
    callStatic: {
        deployAccount(entryPoint: PromiseOrValue<string>, owner: PromiseOrValue<string>, guardian: PromiseOrValue<string>, salt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        getAddress(entryPoint: PromiseOrValue<string>, owner: PromiseOrValue<string>, salt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
