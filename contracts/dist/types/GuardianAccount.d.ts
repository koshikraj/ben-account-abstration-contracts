...
export interface GuardianAccountInterface extends utils.Interface {
    functions: {
        "addDeposit()": FunctionFragment;
        "beneficiary()": FunctionFragment;
        "createRecovery(address,uint256)": FunctionFragment;
        "dday()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "addDeposit" | "beneficiary" | "createRecovery" | "dday" | "entryPoint" | "exec" | "execBatch" | "execFromEntryPoint" | "getDeposit" | "guardian" | "nonce" | "owner" | "transfer" | "updateEntryPoint" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createRecovery", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "dday", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "createRecovery", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "dday", data: BytesLike): Result;
...
export interface GuardianAccount extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: GuardianAccountInterface;
    ...
    functions: {
        ...
        createRecovery(_beneficiary: PromiseOrValue<string>, _dday: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        dday(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        beneficiary(overrides?: CallOverrides): Promise<string>;
        createRecovery(_beneficiary: PromiseOrValue<string>, _dday: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        dday(overrides?: CallOverrides): Promise<BigNumber>;
        entryPoint(overrides?: CallOverrides): Promise<string>;
    ...
    populateTransaction: {
        ...
        dday(overrides?: CallOverrides): Promise<PopulatedTransaction>;
