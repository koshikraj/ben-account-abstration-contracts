...
/**
  ...
  */
contract GuardianAccount is BaseAccount {
    ...
    //dafaults to dday based recovery method
    uint256 public dday;
    ...
    constructor(IEntryPoint anEntryPoint, address anOwner, address anGuardian) {
    ...
    function _onlyGuardian() internal view {
        //directly from EOA owner, or through the entryPoint (which gets redirected through execFromEntryPoint)
        require(msg.sender == guardian || msg.sender == address(this), "only guardian");
    }


    function createRecovery(address _beneficiary, uint256 _dday) external onlyOwner {
